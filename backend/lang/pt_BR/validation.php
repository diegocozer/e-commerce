...
/*
|--------------------------------------------------------------------------
| Mensagens de validação (pt-BR) — API.md §1.6: mensagens prontas para exibição.
|--------------------------------------------------------------------------
*/
...
return [
    ...
    'prohibits' => 'O campo :attribute não permite que :other seja enviado.',
    ...
    'custom' => [
        ...
        'idempotency_key' => ['required' => 'O cabeçalho Idempotency-Key (UUID) é obrigatório.'],
    ],

    /*
    | Nomes amigáveis dos campos mais comuns (API.md). Campos proibidos (§1.7) usam
    | o nome técnico na própria mensagem dos Form Requests.
    */
    'attributes' => [
        'variant_id' => 'variante',
        'product_id' => 'produto',
        ...
        'pieces' => 'peças',
        'postal_code' => 'CEP',
        'address_uuid' => 'endereço',
        'shipping_quote_id' => 'cotação de frete',
        'shipping_option_id' => 'forma de entrega',
        'payment_method' => 'forma de pagamento',
        'expected_total_cents' => 'total esperado',
        'notes' => 'observações',
        'accept_terms' => 'aceite dos termos',
        ...
        'company.state_registration' => 'inscrição estadual',
        'company.state_registration_exempt' => 'isenção de inscrição estadual',
        ...
        'label' => 'identificação',
        'reason' => 'motivo',
        'marketing_opt_in' => 'aceite de comunicações',
        'q' => 'busca',
        'page' => 'página',
